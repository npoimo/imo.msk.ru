...
const contact = async (req, res) => {
  ...
  const subject = 'Новая заявка с imo.msk.ru'
      ...
      <html lang="ru">
        <head>
          ...
          <style>
            ...
            .bgBorderHighlight {
              border-bottom: 2px solid #0073A9;
            }
  ...
  try {
    const emailRes = await transporter.sendMail({
      from: 'lead@imo.msk.ru',
      to: `${
        dev
          ? 'nova@ipo.msk.ru, novailoveyou3@gmail.com'
          : 'npoimo@yandex.ru, info@imo.msk.ru mipo-378329-o0ia@yandex.ru info@ipo.msk.ru iconelp@yandex.ru'
      }`,
