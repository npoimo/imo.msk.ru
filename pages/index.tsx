    ...
    <>
      <NextSeo
        ...
        description={truncate(
          `✅ Можно вернуть 13% НДФЛ; ✅ Есть гос. аккредитация и сертификаты; ✅ Рассрочка от института Без переплат; ✅ Дистанционное обучение без отрыва от работы; ✅ Дипломы котируются по всему миру; ✅ Ведущие эксперты, преподаватели-практики`,
          120
        )}
